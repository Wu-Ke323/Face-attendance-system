		...
		<div class="tpl-right-item">
			<div class="tpl-body">
				...
				<div class="tpl-content">
					<div class="tpl-pannel clearfix">
						<div class="tpl-h-title">
							<a>历史考勤<style=argin-top:0.75rem >
								<form class="form-search" method="post">
									<p>
										<input class="input-medium search-query" type="text" name="inputfind" id="inputfind" />
						...
						<table class="layui-table" lay-even="" lay-skin="row">
							...
							<tbody>
								...
								<tr>
									...
									<td>
									    <a href="teacher2前端.php?course_id=<?php echo $course_id;?>" ><h4>进入</h4></a>
									</td>
								</tr>
								<?php  } } 
								//如果查找不空
